		...
		<ul class="side-menu">
			...
			@can('الفواتير')
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">عرض جميع الفواتير</a></li>
						@endcan

						@can('الفواتير المدفوعة')	
						<li><a class="slide-item" href="{{ route('invoices.invoicesPaid') }}">الفواتير المدفوعه</a></li>
						@endcan
						
						@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ route('invoices.invoicesUnpaid') }}">الفواتير الغير المدفوعه</a></li>
						@endcan

						@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ route('invoices.partialInvoices') }}">الفواتير المدفوعه جزئيا</a></li>
						@endcan	
						
						@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ route('invoices.invoicesArchived') }}">الفواتير المؤرشفه</a></li>
						@endcan
					</ul>
				</li>
			@endcan
