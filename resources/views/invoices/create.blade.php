    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
				...
				<span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافه فاتوره</span>
			</div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="number" name="Rate_VAT" value="{{ old('Rate_VAT') }}" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                @error("Rate_VAT")
                                    <span class="text-danger">{{ $message }} </span>
                                @enderror
                            </div>
