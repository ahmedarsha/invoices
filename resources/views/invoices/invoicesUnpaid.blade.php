...
@section('title','الفواتير الفير مدفوعه')
...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<a class="content-title mb-0 my-auto" href="{{route('home')}}">الصفحه الرئيسيه</a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  الفواتير الغير مدفوعه</span>
			</div>
		</div>
	</div>
	<!-- breadcrumb -->
